    ...
    >
      ...
      <div className="md:w-[50%] flex flex-col gap-5">
        ...
        <p className="text-sm leading-6 text-gray-300">
          Faça este teste para descobrir o quanto você sabe sobre a sitcom
          animada de sucesso Family Guy. Teste seu conhecimento sobre os
          personagens, os episódios e as muitas referências da cultura pop da
          série.
        </p>
        <Link
